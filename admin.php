...
function dc_swp_str( $key ) {
	...
	if ( null === $s ) {
		...
		$s  = $da ? array(
			...
			'ssga4_secret_desc'              => 'Opret i GA4 Admin → Datastrømme → Measurement Protocol API Secrets → Opret. <a href="https://support.google.com/analytics/answer/9900444" target="_blank" rel="noopener">Vejledning ↗</a>',
			...
			'ssga4_secret_desc'              => 'Create in GA4 Admin → Data Streams → Measurement Protocol API Secrets → Create. <a href="https://support.google.com/analytics/answer/9900444" target="_blank" rel="noopener">Instructions ↗</a>',
